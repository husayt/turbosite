      ...
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <p class="text-lg text-slate-400">
            Various versions of Lorem Ipsum have evolved over the years, sometimes by accident, sometimes on purpose, and
            by injecting humour and the like.
          </p>
        </div>
        <!-- Team members -->
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-6">
          <template v-for="item in items" :key="item.id">
            ...
            >
              ...
              <a
                class="shrink-0 text-slate-500 md:opacity-0 group-hover:opacity-100 focus-within:opacity-100 focus:outline-none group-hover:before:absolute group-hover:before:inset-0"
                :href="item.twitter" :aria-label="`${item.name}'s Twitter`"
              >

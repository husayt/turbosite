    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
      <div class="relative pb-12 md:pb-20">
        ...
        <div class="text-center">
            ...
            >
              <template v-for="(item, index) in items" :key="index">
                <div v-show="active === index" class="absolute inset-0 h-full -z-10">
                  <img
                    class="relative top-11 left-1/2 -translate-x-1/2 rounded-full" :src="item.img" width="56"
          ...
          <div class="mb-10">
            <transition-group
              tag="div" class="relative flex flex-col"
          ...
          <div class="flex flex-wrap justify-center -m-1.5">
            <template v-for="(item, index) in items" :key="index">
              ...
              >
                <span class="relative">
                  <span class="text-slate-50">{{ item.name }}</span> <span class="text-slate-600">-</span> <span>{{
                    item.role }}</span>
                </span>
              </button>
            </template>

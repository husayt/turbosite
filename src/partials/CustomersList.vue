...
<template>
  <div class="max-w-[352px] mx-auto sm:max-w-[728px] lg:max-w-none pb-12 md:pb-20">
    <Highlighter
      class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 group [&_*:nth-child(n+5):not(:nth-child(n+12))]:order-1 [&_*:nth-child(n+10):not(:nth-child(n+11))]:!order-2"
    >
            ...
            <HighlighterItem02>
              <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                ...
                <div class="flex items-center justify-center">
                  <img
                    class="w-full h-full aspect-video object-cover" :src="item.bg" width="352" height="198"
                    alt="Customer Background" aria-hidden="true"
                  >
      ...
      <div class="flex flex-col items-center justify-center text-center p-4">
        <p
          class="font-medium bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-3"
        >
          <span class="line-clamp-4">
            “We struggled to bring all our conversations into one place until we found Stellar. The UI is very clean and
            we love the integration with Spark.”
          </span>
        </p>
        ...
        <div class="text-sm font-medium text-slate-300">
          Mike Hunt <span class="text-slate-700">-</span> <a
      ...
      <div class="flex flex-col items-center justify-center text-center p-4">
        ...
        <div class="text-sm font-medium text-slate-300">
          Mirko Mitt <span class="text-slate-700">-</span> <a
            class="text-purple-500 hover:underline"
            href="#0"
          >Mildrink</a>
        </div>

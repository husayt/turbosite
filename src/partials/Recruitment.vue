...
<template>
  <section class="relative">
    <!-- Blurred shape -->
    <div
      class="absolute top-0 -translate-y-1/3 left-1/2 -translate-x-1/2 ml-24 blur-2xl opacity-50 pointer-events-none -z-10"
      aria-hidden="true"
    >
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div
        class="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]"
      >
        <!-- Section header -->
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <p class="text-lg text-slate-400">
            We are makers at heart. Problem solvers and storytellers. We are a diverse team of individuals who build
        ...
        <div class="grid md:grid-cols-3 gap-6 lg:gap-10 max-w-xs mx-auto md:max-w-none -m-5">
          ...
          <div class="text-center p-5">
            <div
              class="inline-flex items-center justify-center h-12 w-12 rounded-full border border-transparent [background:linear-gradient(theme(colors.slate.800),_theme(colors.slate.800))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] mb-3"
            >
    ...
    <div class="max-w-[1440px] mx-auto px-4 md:px-0">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 md:-mx-5">
        <img
          class="w-full aspect-[16/10] object-cover rounded-lg" src="/images/recruitment-01.jpg" width="352"
          height="220" alt="Recruitment 01"
        >
        <img
          class="w-full aspect-[16/10] object-cover rounded-lg" src="/images/recruitment-02.jpg" width="352"
          height="220" alt="Recruitment 02"
        >
        <img
          class="w-full aspect-[16/10] object-cover rounded-lg" src="/images/recruitment-03.jpg" width="352"
          height="220" alt="Recruitment 03"
        >
        <img
          class="w-full aspect-[16/10] object-cover rounded-lg" src="/images/recruitment-04.jpg" width="352"
          height="220" alt="Recruitment 04"
        >
      </div>
    </div>
    ...
    <div class="relative px-4 sm:px-6">
      <!-- Blurred shape -->
      <div
        class="absolute top-0 left-1/2 -translate-x-1/2 translate-y-1/3 ml-24 blur-2xl opacity-40 pointer-events-none"
        aria-hidden="true"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="434" height="427">
          <defs>
      ...
      <div class="max-w-3xl mx-auto py-12 md:py-20">
        <h3
          class="h3 inline-flex bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-8 md:pb-16"
        >
          Open positions
        </h3>
        <div class="space-y-8">
              ...
              <ul class="divide-y divide-slate-800">
                <template v-for="position in item.positions" :key="position.id">
                  <li class="flex flex-col md:flex-row flex-wrap justify-between py-5">
                    ...
                    <a class="inline-flex text-sm font-medium text-purple-500 group" :href="position.link">{{
                      position.location }} <span
                      class="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1"
                    >-&gt;</span></a>
                  </li>
                </template>
              </ul>
